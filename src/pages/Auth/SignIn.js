            ...
            <div className="border drop-shadow-2xl bg-white rounded-lg py-9 px-4 max-w-xs w-full space-y-8">
                ...
                <form className="mt-8  space-y-6" onSubmit={handleSubmit}>
                    ...
                    <div>
                        <button
                            type="submit"
                            className="group mx-auto flex justify-center items-center py-2 px-7 rounded border border-transparent text-sm font-medium text-white bg-green-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
                        >
                   ...
                   <div className="!mt-1">
                        <Link className="font-medium text-black bg-pink-600 hover:text-amber-700" to={"/forgot-password"}>Forgot Password?</Link>
                    </div>
                    <div className="!mt-4">
                        <Link className="font-medium text-black  bg-pink-600 hover:text-amber-600" to={"/signup"}>Sign Up</Link>
                    </div>
                   </div>
